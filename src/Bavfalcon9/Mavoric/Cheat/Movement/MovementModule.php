...
use Bavfalcon9\Mavoric\Cheat\Movement\Speed;
use Bavfalcon9\Mavoric\Cheat\Movement\Velocity;
use Bavfalcon9\Mavoric\Cheat\CheatModule;
use Bavfalcon9\Mavoric\Mavoric;
use Bavfalcon9\Mavoric\Loader;
use pocketmine\event\Listener;

class MovementModule extends CheatModule {
    /** @var Cheat[] */
    private $cheats;
    ...
    public function registerAll(Mavoric $mavoric, Loader $plugin, array $disabled): void {
        $this->cheats[] = new Speed($mavoric);
        $this->cheats[] = new Velocity($mavoric);
